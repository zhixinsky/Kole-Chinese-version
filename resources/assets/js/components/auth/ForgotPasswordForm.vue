<template>
  ...
  >
    <h1 class="text-2xl mb-4">忘记密码</h1>
    ...
    <FormRow>
      <div class="flex flex-col gap-3 sm:flex-row sm:gap-0 sm:content-stretch">
        <TextInput
          ...
          type="email"
        />
        <Btn :disabled="loading" class="sm:rounded-l-none sm:rounded-r" type="submit">重置密码</Btn>
        <Btn :disabled="loading" class="!text-k-text-secondary" transparent @click="cancel">取消</Btn>
      </div>
    </FormRow>
  </form>
</template>
