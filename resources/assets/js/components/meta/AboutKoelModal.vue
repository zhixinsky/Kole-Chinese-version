<template>
  ...
  >
    <main class="p-6">
      ...
      <p v-if="!isPlus">
        喜欢 Koel 吗？请考虑通过以下方式支持其开发
        <a href="https://github.com/users/phanan/sponsorship" rel="noopener" target="_blank">GitHub 赞助</a>
        和/或
        <a href="https://opencollective.com/koel" rel="noopener" target="_blank">开放集体</a>.
      </p>
    </main>

    <footer>
      <Btn danger data-testid="close-modal-btn" rounded @click.prevent="close">关闭</Btn>
    </footer>
  </div>
</template>
